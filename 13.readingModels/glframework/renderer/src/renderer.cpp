                            ...
                            const std::shared_ptr<AmbientLight> &ambientLight)
{
        ...
        for (auto &child: children) {
                this->renderObject(child, camera, directionalLight, ambientLight);
        }
}
                      ...
                      const std::shared_ptr<AmbientLight> &ambientLight)
{
        ...
        /* 3.从scene根节点绘制 */
        renderObject(std::static_pointer_cast<Object>(scene), camera, directionalLight, ambientLight);
}
