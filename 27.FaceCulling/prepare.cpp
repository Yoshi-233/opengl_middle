...
void prepareAll()
{
        ...
        auto planeMat1 = std::make_shared<OpacityMaskMaterial>();
        planeMat1->setDiffuse(std::make_shared<Texture>("assets/textures/grass.jpg", 0));
        // planeMat1->setOpacityMask(std::make_shared<Texture>("assets/textures/grassMask.png", 1));
        planeMat1->mFaceCulling = true;
        planeMat1->mBlend = true;
