...
void prepareAll()
{
        ...
        auto sphereMesh = std::make_shared<InstanceMesh>(sphereGeo, sphereMat, 3);
        glm::mat4 transform0{1.0f};
        ...
        sphereMesh->instanceData[0] = transform0;
        sphereMesh->instanceData[1] = transform1;
        sphereMesh->instanceData[2] = transform2;
